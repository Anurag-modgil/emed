...
export const FIND_PRODUCTS_BY_SALT_REQUEST = 'FIND_PRODUCTS_BY_SALT_REQUEST';
export const FIND_PRODUCTS_BY_SALT_SUCCESS = 'FIND_PRODUCTS_BY_SALT_SUCCESS';
export const FIND_PRODUCTS_BY_SALT_FAILURE = 'FIND_PRODUCTS_BY_SALT_FAILURE';
